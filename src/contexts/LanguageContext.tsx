...
const translations = {
  en: {
    ...
    "projects.community.status": "Local crew raised the structural walls and prepared the roof. Next step: wall, bathroom, electronics & interior finishing.",
  ...
  de: {
    ...
    "projects.community.status": "Unser Team vor Ort hat die Wände gemauert und das Dach fertiggestellt. Nächster Schritt: Wände, Bad, Elektronik & Innenausstattung finalisieren.",
