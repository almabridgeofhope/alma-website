...
const translations = {
  en: {
    ...
    "projects.mobility.status": "In preparation – vehicle acquisition and driving program setup",
    ...
    "projects.sponsorship.goal3": "Strengthen community-led education through shared infrastructure",
    "projects.sponsorship.impact": "This project breaks financial and logistical barriers to education and connects directly to the Young Mobility initiative, ensuring that one shared system benefits both children and young adults.",
    "projects.sponsorship.status": "Planning phase – cost analysis and partnership coordination with local schools",
  ...
  de: {
    ...
    "projects.sponsorship.goal3": "Gemeinschaftsgeleitete Bildung durch geteilte Infrastruktur stärken",
    "projects.sponsorship.impact": "Das Projekt überwindet finanzielle und logistische Bildungsbarrieren und verknüpft sich direkt mit der Young Mobility Initiative – ein gemeinsames System, das sowohl Kindern als auch jungen Erwachsenen zugutekommt.",
    "projects.sponsorship.status": "Planungsphase – Kostenanalyse und Koordination der Partnerschaften mit lokalen Schulen",
